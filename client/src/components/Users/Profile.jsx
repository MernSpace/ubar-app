...
const Profile = () => {
    ...
    let emailRef, firstNameRef, lastNameRef, mobileRef, userImgRef, userImgView = useRef();
    ...
    const UpdateMyProfile = async () => {
        ...
        if (IsEmail(email)) {
            ...
            let result = await ProfileUpdateRequest(email, fastName, lastName, mobile, photo)
            if (result === true) {
                navigate("/")
            }
        }
                        ...
                        <div className="card-body">
                            <div className="container-fluid">
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-4 p-2">
                                        <label>Mobile</label>
                                        <input key={Date.now()} defaultValue={ProfileData['phone']} ref={(input) => mobileRef = input} placeholder="Mobile" className="form-control animated fadeInUp" type="mobile" />
                                    </div>
                                    <div className="col-4 p-2">
                                    </div>
                                    <div className="col-4 p-2">
